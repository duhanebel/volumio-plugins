...
function startStreaming(userId) {
  ...
  const streamUrl =
    'https://stream-mz.hellorayo.co.uk/planetrock_premhigh.aac?' +
    'direct=false' +
    `&listenerid=${userId}&aw_0_1st.bauer_listenerid=${userId}&aw_0_1st.playerid=BMUK_inpage_html5` +
    `&aw_0_1st.skey=${currentEpoch}&aw_0_1st.bauer_loggedin=true` +
    `&user_id=${userId}&aw_0_1st.bauer_user_id=${userId}&region=GB`;
